defmodule TimeManagerApiWeb.UserTeamControllerTest do
  use TimeManagerApiWeb.ConnCase

  alias TimeManagerApi.UserTeamContext
  alias TimeManagerApi.UserTeamContext.UserTeam
  ...
  def fixture(:user_team) do
    {:ok, user_team} = UserTeamContext.create_user_team(@create_attrs)
    user_team
  end
